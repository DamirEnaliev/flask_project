...
def api_product_insert():
    ...
    db.session.commit()
    product_json = {"id_customer": product.id, "type_customer": product.type, "brand_customer": product.brand, "country_customer": product.country, "price_customer": product.price, "amount_customer": product.amount}
    return jsonify(product_json)
